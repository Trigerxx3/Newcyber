#!/usr/bin/env python3
"""
Simple Interactive Database Viewer for Cyber Intelligence Platform
User-friendly interface to access and view all database data (No Unicode)
"""
...
class SimpleInteractiveViewer:
    ...
    def view_all_tables_data(self):
        ...
        for table in tables:
            table_name = table[0]
            self.view_table_data(table_name, limit=3)  # Show first 3 rows of each table
            print("\n" + "-"*60)
    ...
    def show_main_menu(self):
        ...
        print("8.  View all tables data")
        print("9.  Show table list")
        print("0.  Exit")
        print("="*80)
...
def main():
    """Main function"""
    viewer = SimpleInteractiveViewer()
